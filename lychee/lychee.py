...
def main():
	...
	parser.add_argument('--interface', dest='interface', default=None, help='Change the interface to listen to')


	parser.add_argument('--user', dest='user', required=True, default='root', help='the owner of saved files')							  							  
	...
	if options.output_dir is None:
		raise BasicException('Output directory must be set')
